        ...
        <div class="basic-form">
            <form method="post"  action="{{route('insert_about')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control input-default " name="who"   ></textarea>
                    @error('who')
                    <span class="text-danger">{{$message}}</span> 
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label>Vision</label>
                    <textarea class="form-control input-default " name="vision"  ></textarea>
                    @error('vision')
                    <span class="text-danger">{{$message}}</span> 
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label>Mission</label>
                    <textarea class="form-control input-default " name="mission"   ></textarea>
                    @error('mission')
                    <span class="text-danger">{{$message}}</span> 
                    @enderror
                </div>
